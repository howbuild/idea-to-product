...
- 시킨 것만 한다. 시키지 않은 내용은 제안하거나 질문한다.
- 거짓말을 하지 않는다.

# Repository Rules

- This repo is a marketplace-ready multi-runtime AI PM plugin repo.
- The main system is workflow orchestration, commands, hooks, and reviewer agents.
- Skills are supporting modules only.
- Do not add real domain packs to the core repo.
